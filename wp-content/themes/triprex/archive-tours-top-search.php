 ...
 * 
 * Template Name: Tours Top Search
 *
    ...
    <div class="container">
        <div class="filter-group">
            <form>
                    ...
                    <div class="row g-xl-4 gy-4">
                            ...
                            <div class="col-xl-3 col-sm-6 d-flex justify-content-center">
                                <div class="single-search-box">
                                    ...
                                    <div class="searchbox-input">
                                        <label><?php echo esc_html__('Destination', 'triprex') ?></label>
                                        <div class="custom-select-dropdown">
                                            <div class="select-input">
                                                <input type="text" readonly value="<?php echo esc_html__('Select', 'triprex') ?>">
                                                <i class="bi bi-chevron-down"></i>
                                            </div>
                                            <div class="custom-select-wrap">
                                                <div class="custom-select-search-area">
                                                    <i class='bx bx-search'></i>
                                                    <input type="text" placeholder="<?php echo esc_attr__('Type Your Destination', 'triprex') ?>">
                                                </div>
                        ...
                        <?php if (!empty($tour_types)) : ?>
                            <div class="col-xl-3 col-sm-6 d-flex justify-content-center">
                                <div class="single-search-box">
                                    ...
                                    <div class="searchbox-input">
                                        <label><?php echo esc_html__('Tour Type', 'triprex') ?></label>
                                        <div class="custom-select-dropdown">
                                            <div class="select-input">
                                                <input type="text" readonly value="<?php echo esc_html__('Select Type', 'triprex') ?>">
                                                <i class="bi bi-chevron-down"></i>
                                            </div>
                        ...
                        <div class="col-xl-3 col-sm-6 d-flex justify-content-center">
                            <div class="single-search-box">
                                ...
                                <div class="searchbox-input">
                                    <label><?php echo esc_html__('When', 'triprex') ?></label>
                                    <div class="custom-select-dropdown">
                                        <div class="select-input">
                                            <input type="text" readonly value="<?php echo esc_attr('Select Month') ?>">
                                            <i class="bi bi-chevron-down"></i>
                                        </div>
                                        <div class="custom-select-wrap two no-scroll">
                                            <ul class="option-list">
                ...
                <button type="submit">
                    <?php echo esc_html__('Search', 'triprex') ?>
                </button>
            </form>
        </div>
    </div>
