                    ...
                    <?php if ($depth < $args['max_depth'] && comments_open()) :  ?>
                        <div class="replay-btn">
                            <?php comment_reply_link(array_merge($args, array(
                                ...
                                'reply_text' => '<svg xmlns="http://www.w3.org/2000/svg" width="14" height="11" viewBox="0 0 14 11">
...
{
    $comment_field = !empty( $fields['comment'] ) ? $fields['comment'] : null;
...
function wc_comment_form_change_cookies($fields)
{
    ...
    $fields['cookies'] = '<p class="comment-form-cookies-consent"><input id="wp-comment-cookies-consent" name="wp-comment-cookies-consent" type="checkbox" value="yes"' . $consent . ' />' .
        '<label for="wp-comment-cookies-consent">' . esc_html__('Please save my name, email address for the next time I comment.', 'triprex') . '</label></p>';
    return $fields;
}
