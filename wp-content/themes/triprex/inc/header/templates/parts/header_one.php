...
// Call the topbar function
Header_Helper::render_top_bar();
?>
<!-- Start header section -->
<header class="header-area style-1">
    <div class="header-logo d-lg-none d-flex">
        <?php
        if (!empty(Egns_Helper::egns_page_option_value('page_header_one_logo', 'url'))) {
            Egns_Helper::get_theme_logo(Egns_Helper::egns_page_option_value('page_header_one_logo', 'url'));
        } else {
    ...
    <div class="main-menu">
        <div class="mobile-logo-area d-lg-none d-flex justify-content-between align-items-center">
            <div class="mobile-logo-wrap">
                <?php
                if (!empty(Egns_Helper::egns_page_option_value('page_header_one_logo_mobile', 'url'))) {
                    Egns_Helper::get_theme_logo(Egns_Helper::egns_page_option_value('page_header_one_logo_mobile', 'url'));
                } else {
                    ...
                    <?php if ($contactType === 'phone') : ?>
                        <div class="hotline-area d-lg-none d-flex">
                            <?php if ($contactType === 'phone' && !empty($item['phone_icon_svg']['url'])) :
                                $phone_ico = $item['phone_icon_svg']['url'];
                            ?>
                                <div class="icon">
                                    <?php Egns_Helper::display_svg($phone_ico) ?>
                                </div>
                            <?php endif ?>
                            <div class="content">
            ...
            <?php foreach ((array) Egns_Helper::egns_get_theme_option('header_contact_info') as $item) : ?>
                ...
                ?>
                    ...
                    <?php elseif ($contactType === 'email') : ?>
                        <div class="hotline-area d-xl-flex d-none">
                            <?php if ($contactType === 'email' && !empty($item['email_icon_svg']['url'])) :
                                $email_icon = $item['email_icon_svg']['url'];
                            ?>
                                <div class="icon">
                    ...
                    <?php elseif ($contactType === 'others') : ?>
                        <div class="hotline-area d-xl-flex d-none">
                            <?php if ($contactType === 'others' && !empty($item['custom_icon_svg']['url'])) :
                                $custom_icon = $item['custom_icon_svg']['url'];
                            ?>
                                <div class="icon">
