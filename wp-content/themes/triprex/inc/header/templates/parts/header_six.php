...
<header class="header-area style-3 four <?php echo (!is_home() && !is_front_page()) ? 'inner-bg' : ''; ?>">
    <div class="header-logo d-lg-none d-flex">
        <?php
        if (!empty(Egns\Helper\Egns_Helper::egns_page_option_value('page_header_six_logo', 'url'))) {
            Egns\Helper\Egns_Helper::get_theme_logo(Egns\Helper\Egns_Helper::egns_page_option_value('page_header_six_logo', 'url'));
        } else {
    ...
    <div class="main-menu">
        <div class="mobile-logo-area d-lg-none d-flex justify-content-between align-items-center">
            <div class="mobile-logo-wrap">
                <?php
                if (!empty(Egns\Helper\Egns_Helper::egns_page_option_value('page_header_six_logo_mobile', 'url'))) {
                    Egns\Helper\Egns_Helper::get_theme_logo(Egns\Helper\Egns_Helper::egns_page_option_value('page_header_six_logo_mobile', 'url'));
                } else {
    ...
    <div class="nav-right d-flex jsutify-content-end align-items-center">
        ...
        <?php if (class_exists('CSF') && Egns\Helper\Egns_Helper::egns_get_theme_option('header_button_enable') == 1) : ?>
            <a href="<?php echo esc_url(Egns\Helper\Egns_Helper::egns_get_theme_option('header_button_link', 'url')) ?>" class="primary-btn1 two d-xl-flex d-none"><?php echo esc_html(Egns\Helper\Egns_Helper::egns_get_theme_option('header_button_text')) ?></a>
        <?php endif ?>
