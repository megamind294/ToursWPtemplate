...
<header class="header-area style-3">
    <div class="header-logo d-lg-none d-flex">
        <?php
        if (!empty(Egns_Helper::egns_page_option_value('page_header_three_logo', 'url'))) {
            Egns_Helper::get_theme_logo(Egns_Helper::egns_page_option_value('page_header_three_logo', 'url'));
        } else {
    ...
    <div class="main-menu">
        <div class="mobile-logo-area d-lg-none d-flex justify-content-between align-items-center">
            <div class="mobile-logo-wrap">
                <?php
                if (!empty(Egns_Helper::egns_page_option_value('page_header_three_logo_mobile', 'url'))) {
                    Egns_Helper::get_theme_logo(Egns_Helper::egns_page_option_value('page_header_three_logo_mobile', 'url'));
                } else {
