...
function egns_register_required_plugins()
{
	...
	$plugins = array(
		...
		array(
			'name'               => esc_html('Triprex Core'),
			'slug'               => 'triprex-core',
			'source'             => esc_url('https://demo.egenslab.com/wp/plugins/triprex-wp/triprex-core.zip?v=1.1.0'),
			'required'           => true,
			'version'            => '1.1.0',
		...
		array(
			'name'               => esc_html('Review X'),
			'slug'               => 'reviewx',
			'source'             => esc_url('https://demo.egenslab.com/wp/plugins/global/reviewx.zip'),
			'required'           => false,
			'version'            => '',
			'force_activation'   => false,
			'force_deactivation' => false,
